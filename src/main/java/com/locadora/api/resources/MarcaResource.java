...
public class MarcaResource {
	...
	public ResponseEntity<List<MarcaDTO>> findAll() {
		...
		List<MarcaDTO> listaMarcasDto = listaMarcas.stream().map(obj -> new MarcaDTO(obj)).collect(Collectors.toList());
		return ResponseEntity.ok().body(listaMarcasDto);

	}

	@RequestMapping(value = "/page", method = RequestMethod.GET)
	public ResponseEntity<Page<MarcaDTO>> findPage(@RequestParam(value = "page", defaultValue = "0") Integer page,
